...
git clone https://github.com/joselitogmartinez/Proyecto-AWS-2024.git &&
cd Proyecto-AWS-2024 &&
cd Frontend
...
cd .. &&
cd Backend &&
echo MONGODB_URL="mongodb+srv://jgironm20:4nS4UNLStmYxDTwn@cluster0.ckdcpb7.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0" > .env &&
